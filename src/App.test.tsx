...
//   hotspots: [
//     {name: 'hotspot1', pitch: 0, yaw: 0, radius: 0.05, distance: 2, idNewScene: {
//       scene: {id: 2, image: '../images/landscape1.jpg', is_stereo: false},
//       hotspots: [
//         {name: 'hotspot3', pitch: 0, yaw: -35, radius: 0.05, distance: 2, idNewScene: {
//           scene: {id: 3, image: '../images/palmbeach.jpg', is_stereo: false}
//         }},
//         {name: 'hotspot4', pitch: 0, yaw: 0, radius: 0.05, distance: 2, idNewScene: {
